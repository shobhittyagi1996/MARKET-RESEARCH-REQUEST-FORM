		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MARKET RESEARCH REQUEST FORM",
									"targetURL": "#comsapmarketresearch-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapmarketresearch-display": {
								"semanticObject": "comsapmarketresearch",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.marketresearch",
									"url": sap.ui.require.toUrl("com/sap/marketresearch")
								}
							}
						}
					}
